...
const mentalhealthSchema = new mongoose.Schema({
  ...
  'Do you have a support system or someone you can talk to when you\'re feeling down?': Number,
  ...
  'Do you engage in activities or hobbies that promote relaxation and well-being?': Number,
  mental_state: String,
});
